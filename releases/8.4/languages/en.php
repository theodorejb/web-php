...
return [
    ...
    'bcmath_description' => '<p>New <code>BcMath\Number</code> object enables object-oriented style and standard mathematical operators when working with arbitrary precision numbers.</p><p>These objects are immutable and implement the <code>Stringable</code> interface, so they can be used in string contexts like <code>echo $num</code>. They can also be passed to the existing <code>bc*</code> functions.</p>',
